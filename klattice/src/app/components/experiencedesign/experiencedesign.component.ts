...
@Component({
  selector: 'app-experiencedesign',
  templateUrl: './experiencedesign.component.html',
  styleUrls: ['./experiencedesign.component.css']
})
export class ExperiencedesignComponent {
